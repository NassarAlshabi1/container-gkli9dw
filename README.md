...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gkli9dw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gkli9dw.containers.anotherwebservice.com/
...
```
git clone git@github.com:NassarAlshabi1/container-gkli9dw.git
cd container-gkli9dw
```
...
```
docker attach container-gkli9dw
```
